...
import com.yuqiyu.lesson.jwt.TokenResult;
import com.yuqiyu.lesson.entity.TokenInfoEntity;
import com.yuqiyu.lesson.entity.UserInfoEntity;
import com.yuqiyu.lesson.jpa.TokenJPA;
import com.yuqiyu.lesson.jpa.UserInfoJPA;
...
public class TokenController
{
            ...
            )
    {
        ...
        else
        {
            ...
            String secret=new String(userDbInfo.get().getAppSecret());
            //如果不存在
            if (userDbInfo==null)
            {
                token.setFlag(false);
            ...
            //验证appSecret是否存在
            else if (!secret.equals(appSecret.replace(" ","+")))
            {
                token.setFlag(false);
            ...
            else
            {
                ...
                if(tokenDBEntity == null)
                {
                    ...
                    tokenDBEntity.setAppId(userDbInfo.get().getAppId());
