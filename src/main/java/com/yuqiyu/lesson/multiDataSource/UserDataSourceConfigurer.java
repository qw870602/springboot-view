...
package com.yuqiyu.lesson.multiDataSource;
...
@EnableJpaRepositories(
        ...
        basePackages = { "com.yuqiyu.lesson.user","com.yuqiyu.lesson.jpa","com.yuqiyu.lesson.entity"}) //设置用户数据源所应用到的包
public class UserDataSourceConfigurer
{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryUser (EntityManagerFactoryBuilder builder) {
        ...
        return builder
                ...
                .packages(new String[]{ "com.yuqiyu.lesson.user","com.yuqiyu.lesson.jpa","com.yuqiyu.lesson.entity" }) //设置应用creditDataSource的基础包名
